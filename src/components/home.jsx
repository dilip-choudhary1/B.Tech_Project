  ...
  return (
    <div className="home-page bg-gray-200 text-white h-screen w-screen flex flex-col mt-10">
      <h2 className="text-4xl font-bold mb-4">
        Welcome to the IITJ Mess Portal
      </h2>
      <h3 className="text-lg mb-8 text-gray-800">
        You can login or sign up using your credentials
      </h3>
          ...
          {isStudent ? (
            <div>
              ...
              <div className="py-4">
                <Link
                  to="/sign-up"
                  className="block mb-2 px-3 py-3 bg-green-500 text-white rounded hover:bg-green-600 transition duration-300"
                >
                  Sign Up
                </Link>
              </div>
              <div className="py-4">
                <Link
                  to="/sign-in"
                  className="block px-3 py-3 bg-green-500 text-white rounded hover:bg-green-600 transition duration-300"
                >
                  Sign In
                </Link>
              </div>
